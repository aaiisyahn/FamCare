...
class ElderlyMapsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityElderlyMapsBinding
    private lateinit var fusedLocationClient: FusedLocationProviderClient
    private lateinit var recyclerView: RecyclerView
    private lateinit var adapter: ElderlyCareAdapter
    ...
    companion object {
        ...
        private const val TAG = "ElderlyMapsActivity"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = ElderlyCareAdapter(emptyList()) { websiteURL ->
    ...
    private fun loadDaycareData(userLocation: Location) {
        ...
        val daycareCollection = firestore.collection("ElderlyCare")

        daycareCollection.get()
            .addOnSuccessListener { result ->
                val daycares = mutableListOf<ElderlyCare>()
